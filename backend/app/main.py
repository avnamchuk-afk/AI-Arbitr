...
DEMO_USER_PROMPT = (
    "Составь договор найма квартиры. Наймодатель передает квартиру нанимателю на 11 месяцев, "
    "плата 60 000 рублей в месяц, обеспечительный платеж 60 000 рублей, коммунальные платежи "
    "по счетчикам оплачивает наниматель."
)
...
**2. Предмет договора**
Наймодатель передает Нанимателю во временное владение и пользование жилое помещение:
квартиру, расположенную по адресу: [адрес квартиры], общей площадью [площадь] кв. м,
кадастровый номер при наличии: [номер].

Квартира передается исключительно для проживания Нанимателя и лиц, заранее согласованных
сторонами. Использование квартиры для предпринимательской деятельности, посуточной сдачи
или размещения третьих лиц без согласия Наймодателя не допускается.

**3. Срок найма**
Договор заключен на срок 11 месяцев: с [дата начала] по [дата окончания].
Если стороны продолжают исполнять договор после окончания срока и не возражают против этого,
они вправе оформить новый договор или дополнительное соглашение.

**4. Плата за найм и порядок расчетов**
Плата за найм составляет 60 000 рублей в месяц.
Наниматель вносит плату ежемесячно не позднее [число] числа текущего месяца путем перевода
на счет Наймодателя либо иным способом, письменно согласованным сторонами.

Коммунальные платежи по индивидуальным приборам учета оплачивает Наниматель на основании
показаний счетчиков. Иные обязательные платежи, не связанные с фактическим потреблением
Нанимателя, оплачивает Наймодатель, если стороны не согласуют иное.

**5. Обеспечительный платеж**
Наниматель передает Наймодателю обеспечительный платеж в размере 60 000 рублей.
Обеспечительный платеж обеспечивает исполнение обязанностей Нанимателя по оплате найма,
коммунальных платежей, возмещению ущерба квартире и имуществу.

При прекращении договора Наймодатель возвращает обеспечительный платеж в течение [срок]
рабочих дней после возврата квартиры, за вычетом подтвержденных задолженностей и стоимости
устранения повреждений, возникших по вине Нанимателя.

**6. Передача квартиры**
Квартира передается по акту приема-передачи. В акте стороны фиксируют состояние квартиры,
перечень имущества, показания счетчиков, количество ключей и выявленные недостатки.

Риск споров о состоянии квартиры снижается, если стороны приложат к акту фотографии или
видеозапись квартиры на дату передачи.

**7. Права и обязанности Наймодателя**
Наймодатель обязуется передать квартиру в состоянии, пригодном для проживания, не препятствовать
пользованию квартирой и заранее предупреждать Нанимателя о необходимости доступа в квартиру.

Наймодатель вправе проверять состояние квартиры не чаще [периодичность], предварительно
уведомив Нанимателя не менее чем за [срок] часов, кроме аварийных случаев.

**8. Права и обязанности Нанимателя**
Наниматель обязуется своевременно оплачивать найм и коммунальные платежи, бережно относиться
к квартире и имуществу, соблюдать правила проживания в доме, не производить перепланировку
и существенные изменения без письменного согласия Наймодателя.

Наниматель обязан незамедлительно сообщать Наймодателю об авариях, протечках, повреждениях
и иных обстоятельствах, которые могут причинить ущерб квартире или соседям.

**9. Текущий ремонт и повреждения**
Мелкие расходы, связанные с обычным использованием квартиры, стороны распределяют следующим
образом: [порядок распределения расходов].

Повреждения, возникшие по вине Нанимателя, членов его семьи, гостей или иных допущенных им лиц,
устраняются за счет Нанимателя. Естественный износ квартиры и имущества не считается ущербом.

**10. Досрочное расторжение**
Каждая сторона вправе предложить досрочное расторжение договора, уведомив другую сторону
не менее чем за [срок] календарных дней.

При существенном нарушении условий договора, включая просрочку оплаты, порчу имущества,
использование квартиры не по назначению или передачу квартиры третьим лицам без согласия,
пострадавшая сторона вправе требовать расторжения договора и возмещения убытков.

**11. Ответственность сторон**
За просрочку внесения платы Наниматель уплачивает неустойку в размере [размер] за каждый день
просрочки, если стороны согласуют такую меру ответственности.

Стороны несут ответственность за нарушение обязательств в соответствии с договором и
...
def ensure_demo_session(db: Session, user: User) -> None:
    ...
    if existing is not None and existing.title == DEMO_SESSION_TITLE:
        return
    ...
    db.add(Message(session_id=session.id, role=MessageRole.system, content=build_reasoning_note(DEMO_USER_PROMPT)))
