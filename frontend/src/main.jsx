...
const PRIVACY_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      "2.4. Сервис использует строго необходимые cookies для сессии, авторизации, безопасности и восстановления открытого договора. Для необязательного голосования о типах договоров браузер сохраняет случайный идентификатор голоса. Рекламные cookies не используются.",
