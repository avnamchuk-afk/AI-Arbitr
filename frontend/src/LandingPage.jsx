...
import ContractTypePoll from "./ContractTypePoll.jsx";
import "./landing.css";
...
const completedRoadmap = [
  ...
  ["0.10", "Типовая форма разработки AI-помощника для интернет-магазина"],
...
const faq = [
  ...
  ["Может ли нейросеть ошибиться?", "Да. Поэтому перед согласованием нужно проверить текст. Найм жилья и разработка AI/SaaS проработаны наиболее полно; остальные виды пока готовятся по универсальному сценарию.", "contract-balance"],
  ...
  ["Какие договоры доступны?", "Наиболее полно проработаны найм жилого помещения и разработка AI/SaaS-сервиса. Другие виды договоров генерируются по универсальному сценарию; следующие типовые формы выберем по запросам пользователей.", "how-contract-generation-works"],
...
export default function LandingPage() {
  ...
  return (
    <main className="landing-page" id="top">
      ...
      <Section eyebrow="Сценарии использования" title="Работайте вдвоем или готовьте договоры для клиентов">
        <div className="landing-use-cases">
          <article>
            <div className="use-case-head">
              <Users size={24} />
              <div><span>Сценарий 1</span><strong>Полный цикл для двух сторон</strong></div>
            </div>
            <ol>
              <li>Подготовьте и уточните договор в чате.</li>
              <li>Отправьте второй стороне ссылку для ознакомления и подписания.</li>
              <li>Получите финальный PDF и используйте AI-Arbitr при исполнении или споре.</li>
            </ol>
          </article>
          <article>
            <div className="use-case-head">
              <BriefcaseBusiness size={24} />
              <div><span>Сценарий 2</span><strong>Конструктор для юриста или риелтора</strong></div>
            </div>
            <p>
              Создавайте профессиональные договоры, дорабатывайте формулировки и храните свои проекты в истории.
              Уберите оговорку о разрешении спора — получите привычный договор для работы вне сервиса.
            </p>
            <p>
              Если клиент готов работать через AI-Arbitr, отправьте ему договор на согласование. Так история сервиса
              становится вашей рабочей базой договоров и каналом ознакомления клиентов с документами.
            </p>
          </article>
        </div>
      </Section>
      ...
      <Section eyebrow="MVP" title="Какие договоры проработаны подробнее?" id="contract-types">
        <p className="landing-lead">
          Наиболее полно проработаны договор найма жилого помещения и договор на разработку AI/SaaS-сервиса.
          Остальные виды доступны через универсальную генерацию. Детализацию новых типовых форм будем выбирать
      ...
      <Section eyebrow="Сценарии" title="Когда использовать AI-Arbitr?">
        <div className="landing-cards">
          <article><Clock3 /><strong>Когда гарантированно нужно быстро</strong><p>Договор нужен сегодня, а не после недели согласований.</p></article>
