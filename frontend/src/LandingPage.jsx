...
const faq = [
  ...
  ["Как разрешаются споры?", "Сторона открывает спор, а AI-Arbitr анализирует условия договора и историю согласования, чтобы за одну минуту предложить досудебное решение в соответствии с договором."],
